...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['teacher', 'parent', 'student'];
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Chapters', path: '/chapters', entity: 'chapter', service: AccessServiceEnum.PROJECT, icon: FiBox },
    { name: 'Questions', path: '/questions', entity: 'question', service: AccessServiceEnum.PROJECT, icon: FiBox },
    {
      name: 'Study Sessions',
      path: '/study-sessions',
    ...
    { name: 'Textbooks', path: '/textbooks', entity: 'textbook', service: AccessServiceEnum.PROJECT, icon: FiBox },
