...
export function QuestionListPage(props: QuestionListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getQuestions({
        ...
        order: params.order,
        searchTermKeys: ['content.contains', 'question_type.contains', 'answer.contains'],
        ...(params.filters || {}),
      }),
  ...
  const columns: ColumnType[] = [
    ...
    { id: 'question_type', header: 'Question Type', accessorKey: 'question_type' },
    ...
    hasAccess('chapter', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          ...
          cell: ({ row: { original: record } }: any) => (
            <Link as={NextLink} onClick={(e) => e.stopPropagation()} href={`/chapters/view/${record.chapter?.id}`}>
