  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Experience Achaarya, your personal learning companion! Our school textbook PDFs chatbot, built with OpenAI's ChatGPT API, is here to help students answer questions and learn better. With future integrations like WolframAlpha for maths and Mermaid for mindmaps, we're redefining the learning journey!"
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience Achaarya, your personal learning companion! Our school textbook PDFs chatbot, built with OpenAI's ChatGPT API, is here to help students answer questions and learn better. With future integrations like WolframAlpha for maths and Mermaid for mindmaps, we're redefining the learning journey!`}
            </Text>
            <Box
